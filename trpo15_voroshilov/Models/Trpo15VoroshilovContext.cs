...
public partial class Trpo15VoroshilovContext : DbContext
{
    public Trpo15VoroshilovContext()
    {
    }

    public Trpo15VoroshilovContext(DbContextOptions<Trpo15VoroshilovContext> options)
        : base(options)
    {
    }
